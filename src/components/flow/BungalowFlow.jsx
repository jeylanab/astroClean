...
const BungalowFlow = ({ propertyInfo, onBack }) => {
      ...
      {/* Step 14: Final Price */}
        {step === 14 && (
          ...
          <div onClick={next} className="drop-in drop-in-3 bg-white-700 p-6 rounded-3xl border-2 border-blue-700 cursor-pointer hover:shadow-2xl hover:shadow-blue-700/20 relative group transition-all">
            <div className="absolute -top-3 left-6 bg-[#37c137] text-white-700 border border-blue-700 px-3 py-0.5 rounded-full text-[8px] font-black uppercase tracking-widest">Popular</div>
            <p className="uppercase font-black text-[10px] mb-2 text-[#010191]/60">Monthly</p>
            <h3 className="text-4xl font-black mb-1 text-[#2ab52a]">£{priceMonthly}</h3>
            <p className="text-[10px] font-black text-[#010191]/60 uppercase">Save £4</p>
            <div className="mt-4 bg-[#20c720] text-white py-2 rounded-lg font-black uppercase text-xs text-center tracking-widest group-hover:bg-blue group-hover:text-[#4b4be8] transition-colors">Select</div>
          </div>
          {/* 2-Monthly */}
          <div onClick={next} className="drop-in drop-in-4 bg-green/5 p-6 rounded-3xl border border-green/10 cursor-pointer hover:border-greeen/30 tgreenion-all group">
            <p className="uppercase font-black text-[10px] mb-2 text-green-500">2-Monthly</p>
            <h3 className="text-4xl font-black mb-1 text-green-500">£{price2Monthly}</h3>
            <div className="mt-4 border border-green/20 py-2 rounded-lg font-black uppercase text-xs text-green/50 text-center group-hover:bg-green group-hover:text-[#20b815] transition-all">Select</div>
          </div>
            </div>
          </div>
        )}
