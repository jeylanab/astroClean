...
const Step3Access = ({ selected, onSelect, onNext }) => {
  const options = [
    ...
    <div className="w-full max-w-4xl flex flex-col items-start animate-in fade-in slide-in-from-bottom-8 duration-1000">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight leading-tight">
          Are we able to reach your windows from ground level?
        </h2>
      </div>

      {/* Subtext */}
      <p className="text-lg text-slate-500 mb-8 max-w-lg">
        For example, there is no balcony or conservatory in the way.
      </p>

      {/* Illustration Card */}
      <div className="mb-10 w-full max-w-[320px] bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100">
        <img 
          src={accessImg} 
      ...
      {/* Yes/No Selection Grid - Wider & Cleaner */}
